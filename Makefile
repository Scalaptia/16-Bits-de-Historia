...
PROJECT_NAME          ?= 16-Bits-de-Historia
PROJECT_VERSION       ?= 1.0
PROJECT_BUILD_PATH    ?= .
...
PROJECT_SOURCE_FILES ?= \
	...
	src/components/debug.c \
	src/components/level.c \
	src/components/animation.c \
	src/components/keybinds.c \
	src/components/menu.c \
	src/components/sound.c \
	src/components/npc.c \
	src/components/object.c \
	src/components/cine.c \
